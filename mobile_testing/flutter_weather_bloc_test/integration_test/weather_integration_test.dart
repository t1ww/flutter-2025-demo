...
void main() {
  group('Weather App Integration Test', () {
    ...
    Widget createTestApp() {
      return MaterialApp(
        home: BlocProvider<WeatherCubit>(create: (_) => WeatherCubit(fakeRepository), child: WeatherPage()),
      );
    }

    testWidgets('shows weather data when fetchWeather succeeds', (WidgetTester tester) async {
      fakeRepository.weatherToReturn = Weather(city: 'Bangkok', temperature: 30.0, description: 'Sunny');
